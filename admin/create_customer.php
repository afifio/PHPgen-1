...
// Add Node Content
  ...
  $partner->appendChild(
  $doc->createTextNode( $customer['partner'] )
  );
  $b->appendChild( $partner );
...
echo "  <ul id='backup_list' ondragstart='dragStartHandler(event)'>";
foreach( $customers as $customer )
{
...
//  $idr = $idr ++;
  ...
  $partners = $customer->getElementsByTagName( "partner" );
  $partner = $partners->item(0)->nodeValue;
  ...
  echo "
  <li draggable='true' data-value='$idr'>

<a style='display:inline;float:right;padding:2px;margin:0 -4px 0 0;' href='$ready_url?node=$idr&amp;u=$name&amp;val=$val' title='Eintrag l&ouml;schen'><!--edit--> <img src='../img/icons/hex_delete.png' witdh='24' height='24' style='padding:0;margin:0 0 -6px 0;' alt='&#10007;' /></a>

<a style='display:inline;float:right;padding:2px;margin:0 -4px 0 0;' href='edit$ready_url?node=$idr&amp;u=$name&amp;val=$val' title='Eintrag Bearbeiten'><!--l&ouml;schen--> <img src='../img/icons/edit.png' witdh='24' height='24' style='padding:0;margin:0 0 -6px 0;' alt='&#10007;' /></a>

  <b>$idr</b> - $name $partner<br>
  $street - $zip - $city<br>
...
<tr>
<td width="256"><span class="style5">Ansprech-Partner :</span></td>
<td width="514">
  <input name="partner" type="text" id="partner" value="Partner"
onblur="if(this.value.length == 0) this.value='Partner';" onclick="if(this.value == 'Ansprech-Partner') this.value='';">
</td>
</tr>
