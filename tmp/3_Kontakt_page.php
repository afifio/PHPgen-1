                        ...
                        <table border="0" cellpadding="10" cellspacing="0" width="100%">
                          <tbody>
                            <tr>
                              ...
                              <!-- *|IFNOT:ARCHIVE_PAGE|* --> <td valign="top" width="190">
...
<!--          <p class="alert">Error submitting the form</p> -->
		...
		<img src="/gen/inc/captcha_form.php<?=$sessionstringnew;?>" alt="Captcha" id="P91Captcha" />
